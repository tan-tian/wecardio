package com.hiteam.common.web.template.freemarker;

import com.hiteam.common.util.bean.EnumConverter;
...
public final class FreemarkerUtils {
	...
	public static <T extends Serializable> String process2(String template, T model) throws IOException, TemplateException {
		if (template == null) {
			return null;
		}
