...
<head>
    ...
    <title><spring:message code="admin.doctor.list.title"/></title>
    <link rel="stylesheet" type="text/css" href="${path}/resources/css/doctorlist_style.css"/>
    <script type="text/javascript" src="${path}/resources/admin/doctor/js/list.js"></script>
</head>
<body>
<div class="pageMain">
    <div class="addressBar">
        ...
        <span class="normal"><spring:message code="admin.bread.doctor"/></span>
    ...
    <div class="objBoxCont" style="margin-bottom:10px;">
        <form id="qform" action="" method="post">
            ...
            <div class="searchFormMain" style="margin-bottom:0px;">
                <div class="crsearch">
                    <input type="text" name="name" style="width:200px;" placeholder='<spring:message code="admin.doctor.placeholder.name"/>' />
                    <a class="queryBtn"></a>
                </div>
            ...
            <div class="khKmainbody xw_kMainContentbody" style=" background:#f6f6f6;min-height:75px; padding:0px; border-top:0px;display:none;">
                <div class="searchFormChose" id="select">
                    <dl>
                        <dt><spring:message code="admin.doctor.form.state"/>：</dt>
                        <dd class="moreSelect">
                            <input type="hidden" id="loginState" name="loginState"/>
                        </dd>
                    </dl>
                    <dl>
                        <dt><spring:message code="admin.doctor.form.roles"/>：</dt>
                        <dd class="moreSelect">
                ...
                <div class="doctorDiv xw_doctorDiv" did="{$T.record.id}">
                    ...
                    <div class="doctorNumber">
                        <table class="doctorNumberTable">
                            ...
                            <tr>
                                <td><spring:message code="admin.doctor.form.patientNum"/></td>
                                <td><spring:message code="admin.doctor.form.orderNum"/></td>
                            </tr>
                        </table>
                    </div>
                </div>
