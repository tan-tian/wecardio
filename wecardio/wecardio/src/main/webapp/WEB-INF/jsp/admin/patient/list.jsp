...
<script type="text/javascript" src="${path}/resources/admin/patient/js/list.js"></script>
    <style type="text/css">
...
<div class="pageMain">
    <div class="addressBar">
        ...
        <span class="normal"><spring:message code="admin.patient.title"/></span>
            ...
            <c:if test="${sessionScope.userTypePath!='admin'}">
                <c:if test="${iType=='2'}"><%--VIP--%>
                    <c:if test="${sessionScope.userTypePath=='doctor'}">
                        <li><a id="bindingBtn"><spring:message code="common.btn.patient.binding"/></a></li><%--绑定邀请--%>
                        <li><a id="binddeviceBtn"><spring:message code="common.btn.patient.binddeviceBtn"/></a></li><%--holter设备绑定--%>
                        <li><a id="3leadbindBtn"><spring:message code="common.btn.patient.3leadbindBtn"/></a></li><%--三导设备绑定--%>
                        <li><a id="holterupBtn"><spring:message code="common.btn.patient.holterupBtn"/></a></li><%--上传设备绑定--%>
                    </c:if>
					<c:if test="${sessionScope.userTypePath=='doctor' || sessionScope.userTypePath=='org'}">
						<li><a id="daichongBtn"><spring:message code="common.btn.patient.daichongBtn"/></a></li><%--代充服务包--%>
					</c:if>
                    <li><a id="addBtn"><spring:message code="common.btn.patient.addPatient"/></a></li><%--新增患者--%>
                </c:if>
                <li><a id="editBtn"><spring:message code="common.btn.patient.editPatient"/></a></li><%--编辑患者--%>
            </c:if>
            <c:if test="${sessionScope.userTypePath=='admin'}">
                <li><a id="deleteBtn"><spring:message code="common.btn.patient.deletePatient"/></a></li><%--删除患者--%>
            </c:if>
        </ul>
    </div>
