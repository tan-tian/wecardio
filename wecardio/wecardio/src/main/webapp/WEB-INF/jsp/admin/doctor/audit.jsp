...
<head>
    ...
    <title><spring:message code="admin.doctor.audit.title"/></title>
    ...
    <script type="text/javascript" src="${path}/resources/admin/doctor/js/audit.js"></script>
</head>
<body>
<div class="">
    <form id="form" action="${path}/admin/doctor/audit" method="post">
        <input type="hidden" id="did" name="did" value="${did}"/>
        <table class="userMsgTableb">
            <tr>
                <th><spring:message code="admin.doctor.form.audit.isPass"/>:</th>
                <td colspan="3">
            ...
            <tr>
                <th><spring:message code="admin.doctor.form.audit.remark"/>:</th>
                <td colspan="3">
