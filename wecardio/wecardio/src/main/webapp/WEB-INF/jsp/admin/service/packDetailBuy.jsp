...
<head>
    ...
    <script type="text/javascript" src="${path}/resources/org/service/js/packDetailBuy.js"></script>
</head>
<body>
<div class="pageMain">
    ...
    <div class="ctrolToolbar">
        <ul class="ctrolToolbarUl">
            <li id="buyBtn"><a><spring:message code="admin.service.lbl.pack.buy"/></a></li>
        </ul>
    </div>
