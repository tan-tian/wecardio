...
<head>
    ...
    <title><spring:message code="admin.organization.list.title"/></title>
    <link rel="stylesheet" type="text/css" href="${path}/resources/css/hospital_style.css"/>
    <script type="text/javascript" src="${path}/resources/admin/organization/js/list.js"></script>
</head>
<body>
<div class="pageMain">
<div class="addressBar">
    ...
    <span class="normal"><spring:message code="admin.bread.organization"/></span>
            ...
            <td class="doctorTd">
                <div class="hospitalDiv" oid="{$T.record.id}">
                    <h1>
                        ...
                        <i title="<spring:message code="admin.organization.list.stop.title"/>" class="stop"><em></em></i>
                        {#elseif $T.record.auditState == 2}
                        <b></b>
                        {#else}
                        <i title="<spring:message code="admin.organization.list.unauthenticated.title"/>"><em></em></i>
                        {#/if}
                    </h1>
                    <div class="hospitalDivCli xw_hospitalDivCli">
                        ...
                        <div class="hospitalNumber">
                            <table class="hospitalNumberTable">
                                ...
                                <tr>
                                    <td><spring:message code="admin.organization.list.patientNum"/></td>
                                    <td><spring:message code="admin.organization.list.doctorNum"/></td>
                                    <td><spring:message code="admin.organization.list.orderNum"/></td>
                                </tr>
                            </table>
                        </div>
                    </div>
