...
<head>
    ...
    <title><spring:message code="admin.consultation.list.title"/></title>
    <link rel="stylesheet" type="text/css" href="${path}/resources/css/dingdanlist_ctr.css"/>
    <script type="text/javascript" src="${path}/resources/admin/consultation/js/list.js"></script>
</head>
<body>
<div class="pageMain">
    <div class="addressBar">
        ...
        <span class="normal"><spring:message code="admin.bread.consultation"/></span>
        <a class="goback" onclick="history.go(-1);"><spring:message code="admin.bread.back"/></a>
    </div>

    <div class="objBoxCont" style="margin-bottom:10px;">
        <form id="qform" action="${path}/admin/consultation/page" method="post">
            ...
            <div class="searchFormMain" style="margin-bottom:0px;">
                <%--
                <div class="crsearch">
                    <input type="text" name="serviceName" style="width:200px;" placeholder="<spring:message code="admin.consultation.placeholder.name"/>"/>
                    <a class="queryBtn"></a>
                </div>
                --%>
                <div class="searchListDiv xw_searchListDiv">
                    ...
                    <input type="text" class="xw_searchListInput" id="xw_searchListInput" name="xw_searchListInput" />
                    <ul class="searchListUl xw_searchListUl">
                    	<li><spring:message code="admin.consultation.query.msg"/></li>
                        <li><span><spring:message code="admin.consultation.query.fullName"/>:</span><a searchProperty="patient.fullName"></a></li>
                        <li><span><spring:message code="admin.consultation.query.mobile"/>:</span><a searchProperty="patient.mobile"></a></li>
                        <li><span><spring:message code="admin.consultation.query.email"/>:</span><a searchProperty="patient.email"></a></li>
                    </ul>
                </div>

                <div class="search_type" style="padding-left:23px; padding-top:0px; padding-right:0px;"><spring:message code="admin.consultation.query.created"/>：</div>
                <div class="dateDiv">
            ...
            <div class="khKmainbody xw_kMainContentbody" style=" background:#f6f6f6;min-height:75px; padding:0px; border-top:0px;display:none;">
                <div class="searchFormChose" id="select">
                    <dl>
                        <dt style="width: 100px;"><spring:message code="admin.consultation.query.state"/>：</dt>
                        <dd class="moreSelect">
                            <input type="hidden" id="state" name="state"/>
                        </dd>
                    </dl>
                    <div class="searchBar" style=" position:relative;z-index:3;">
                        <span class="spanName"><spring:message code="admin.consultation.query.doctor"/>：</span>
                        <input type="text" id="doctor" name="doctor" class="normalInput"/>
                    </div>
                    <div class="searchBar" style=" position:relative;z-index:3;">
                        <span class="spanName"><spring:message code="admin.consultation.query.editDoctor"/>：</span>
                        <input type="text" name="editDoctor" class="normalInput"/>
                    </div>
                    <div class="searchBar" style=" position:relative;z-index:3;">
                        <span class="spanName"><spring:message code="admin.consultation.query.auditDoctor"/>：</span>
                        <input type="text" name="auditDoctor" class="normalInput"/>
                    </div>
                    <div class="searchBar" style=" position:relative;z-index:1;">
                        <span class="spanName"><spring:message code="admin.consultation.query.org"/>：</span>
                        <input type="text" id="oid" name="oid" class="normalInput"/>
                    </div>
                    <div class="searchBar" style=" position:relative;z-index:1;">
                        <span class="spanName"><spring:message code="admin.consultation.query.serviceType"/>：</span>
...
<textarea id="template" rows="0" cols="0" style="display: none">
    ...
    <div class="sgListLiMain xw_sgListLiMain" cid="{$T.record.id}" guid="{$T.record.guid}">
        ...
        <div class="sgListLiMainCenter xw_sgListLiMainCenter">
            ...
            <ul class="sgMsg">
                <li><span><spring:message code="admin.consultation.list.patient"/>:</span><a>{$T.record.patientName}</a></li>
                <li><span><spring:message code="admin.consultation.list.doctor"/>:</span><a>{$T.record.doctorName}</a></li>
                <li><span><spring:message code="admin.consultation.list.org"/>：</span><a>{$T.record.orgName}</a></li>
                <li><span><spring:message code="admin.consultation.list.paykind"/>：</span><a>{$T.record.payKindName}</a></li>
                <li><span><spring:message code="admin.consultation.list.price"/>：</span><a>{$T.record.price}</a></li>
            </ul>
        </div>
    </div>
    {#/for}
