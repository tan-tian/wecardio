...
<head>
    ...
    <script type="text/javascript" src="${path}/resources/org/service/js/daichong.js"></script>
</head>
<body>
        ...
        <div class="objBoxBody xw_objBoxFirstTabBody"
            ...
            <div class="objBoxBodyb xw_objBoxFirstBodyb" style="display:block; background:none; border:0px;">
                <div class="titleBar">
                    ...
                    <h1 class="dataTotalTitle"><spring:message code="admin.service.lbl.count"/>&nbsp&nbsp
                    	<spring:message code="admin.daichong.patientName"/>:${patientName}</h1>
                </div>
