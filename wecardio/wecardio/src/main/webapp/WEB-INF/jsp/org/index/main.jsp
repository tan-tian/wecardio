...
<head>
    ...
    <script type="text/javascript" src="${path}/resources/org/index/js/main.js"></script>
</head>
<body>
<div class="headDiv">
...
<div class="BodyMain">
    <div class="leftMain xw_leftMain">
        <div id="listBox">
            <div class="menuUlBox noArrow">
                <div class="menuUlBoxHead ico_home menuUlBoxHeadOn" pagetype="0" hrefvalue="${path}/org/home" clicktype="3">
                    <h1 class="up"><spring:message code="org.main.homeNav"/></h1>
                    <h2>Homepage</h2><a></a>
                </div>
            </div>
            <div class="menuUlBox noArrow">
                <div class="menuUlBoxHead ico_hospital" pagetype="0" hrefvalue="${path}/org/organization" clicktype="3">
                    <h1><spring:message code="org.main.orgNav"/></h1>
                    <h2>Organization</h2><a></a>
                </div>
            </div>
            <div class="menuUlBox noArrow">
                <div class="menuUlBoxHead ico_doctor" pagetype="0" hrefvalue="${path}/org/doctor" clicktype="3">
                    <h1><spring:message code="org.main.doctorNav"/></h1>
                    <h2>Doctor</h2><a></a>
                </div>
            </div>
            ...
            <div class="menuUlBox">
                <div class="menuUlBoxHead ico_huanzhe" clicktype="2">
                    <h1><spring:message code="org.main.patientNav"/></h1>
                    <h2>Patient</h2><a></a>
                </div>
                <ul class="menuBtListUl">
                    ...
                    <li pagetype="2" hrefvalue="${path}/${sessionScope.userTypePath}/patient?iType=2"><spring:message code="admin.main.patient.vipNav"/></li>
                </ul>
            </div>
            <div class="menuUlBox noArrow">
                <div class="menuUlBoxHead ico_list" pagetype="0" hrefvalue="${path}/org/consultation/list" clicktype="3">
                    <h1><spring:message code="org.main.diagnosisNav"/></h1>
                    <h2>Diagnosis</h2><a></a>
                </div>
            </div>
            <div class="menuUlBox noArrow">
                <div class="menuUlBoxHead ico_jiancha" pagetype="0" hrefvalue="${path}/org/record" clicktype="3">
                    <h1><spring:message code="org.main.checkNav"/></h1>
                    <h2>Check</h2><a></a>
                </div>
            </div>
            <div class="menuUlBox noArrow">
            ...
            <div class="menuUlBox noArrow">
                <div class="menuUlBoxHead ico_money" clicktype="2">
                    <h1><spring:message code="org.main.accountNav"/></h1>
                    <h2>Account</h2><a></a>
                </div>
                <ul class="menuBtListUl">
                    <li pagetype="2" hrefvalue="${path}/org/wallet"><spring:message code="org.main.walletNav"/></li>
                    <li pagetype="2" hrefvalue="${path}/org/withdraw/todo"><spring:message code="org.main.withdrawNav"/></li>
                </ul>
            </div>
            <div class="menuUlBox noArrow">
                <div class="menuUlBoxHead ico_xiaoxi" pagetype="0" hrefvalue="${path}/${sessionScope.userTypePath}/message" clicktype="3">
                    <h1><spring:message code="org.main.messageNav"/></h1>
                    <h2>Message</h2><a></a>
                </div>
            </div>
            <div class="menuUlBox noArrow">
    ...
    <div class="rightPage xw_rightMain">
        <iframe id="iframe" frameborder="0" width="100%" scrolling="no" src="${path}/org/home" onLoad="setFrameHeight()"></iframe>
    </div>
</div>
