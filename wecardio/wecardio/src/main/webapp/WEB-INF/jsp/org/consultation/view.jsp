...
<head>
    ...
    <title><spring:message code="org.consultation.view.title"/></title>
    <link rel="stylesheet" type="text/css" href="${path}/resources/css/dingdandetail_style.css"/>
    <script type="text/javascript" src="${path}/resources/org/consultation/js/view.js"></script>
</head>
<body>
<div class="pageMain">
    <div class="addressBar">
        ...
        <a class="jumpback" href="${path}/org/consultation/list"><spring:message code="org.bread.consultation"/></a>
        <span class="arrowText">&gt;</span>
        <span class="normal"><spring:message code="org.bread.consultation.view"/></span>
    ...
    <div class="projectDetailHead projectDetailHeadA">
        <div class="YDDetailStact">
            <div class="YDDetailStactDiv YDDetailStactDivA">
                ...
                <h3>[<spring:message code="org.consultation.view.state"/>]</h3>
            </div>
        ...
        <div class="projectDetailHeadTitle">
            ...
            <span><spring:message code="org.consultation.view.price"/>:<b>${consultation.price}</b></span>
        </div>
        <div class="projectDetailHeadBody">
            <div class="projetListConFoot">
                <table class="userMsgTable">
                    <tr>
                        <td><spring:message code="org.consultation.view.patient"/>:</td><th>${consultation.patientName}</th>
                        <td><spring:message code="org.consultation.view.doctor"/>:</td><th>${consultation.doctorName}</th>
                        <td><spring:message code="org.consultation.view.paykind"/>:</td><th>${consultation.payKindName}</th>
                    </tr>
                    <tr>
                        <fmt:formatDate value="${consultation.testDate}" var="testDate" pattern="yyyy-MM-dd HH:mm:ss" />
                        <td><spring:message code="org.consultation.view.tested"/>:</td><th>${testDate}</th>
                        <fmt:formatDate value="${consultation.recordCreateDate}" var="recordCreateDate" pattern="yyyy-MM-dd" />
                        <td><spring:message code="org.consultation.view.created"/>:</td><th>${recordCreateDate}</th>
                        <fmt:formatDate value="${consultation.reportDate}" var="reportDate" pattern="yyyy-MM-dd" />
                        <td><spring:message code="org.consultation.view.reported"/>:</td><th>${reportDate}</th>
                    </tr>
                    <tr>
                        <td><spring:message code="org.consultation.view.symptom"/>:</td><th>${consultation.condition}</th>
                        <td><spring:message code="org.consultation.view.org"/>:</td><th>${consultation.orgName}</th>
                    </tr>
                    <tr>
                        <td><spring:message code="org.consultation.view.doctorOpinion"/>:</td><th  colspan="3">${consultation.doctorOpinion}</th>
                    </tr>
                </table>
            </div>
        </div>
    ...
    <div class="userMain" style="margin-bottom:10px;">
        <div class="userDetailCont" style="padding-top:0px;">
            <div class="userDetailContHead">
                <h1 class="userDetailConthText"><spring:message code="org.consultation.view.pdf"/></h1>
