...
<head>
    ...
    <title><spring:message code="org.record.list.title"/></title>
    <link rel="stylesheet" type="text/css" href="${path}/resources/css/dingdanlist_ctr.css"/>
    <script type="text/javascript" src="${path}/resources/org/record/js/list.js"></script>
</head>
<body>
<div class="pageMain">
    ...
    <div class="objBoxCont" style="margin-bottom:10px;">
        <form id="qform" action="${path}/org/record/page" method="post">
            ...
            <div class="searchFormMain" style="margin-bottom:0px;">
                <%--
                <div class="crsearch">
                    <input type="text" name="serviceName" style="width:200px;" placeholder='<spring:message code="org.record.placeholder.name"/>' />
                    <a class="queryBtn"></a>
                </div>
                --%>
                <div class="searchListDiv xw_searchListDiv">
                    ...
                    <ul class="searchListUl xw_searchListUl">
                        ...
                        <li><span><spring:message code="org.record.query.fullName"/>:</span><a searchProperty="patient.fullName"></a></li>
                        <li><span><spring:message code="org.record.query.mobile"/>:</span><a searchProperty="patient.mobile"></a></li>
                        <li><span><spring:message code="org.record.query.email"/>:</span><a searchProperty="patient.email"></a></li>
                    </ul>
                </div>

                <div class="search_type" style="padding-left:23px; padding-top:0px; padding-right:0px;"><spring:message code="org.record.query.testTime"/>：</div>
                <div class="dateDiv">
            ...
            <div class="khKmainbody xw_kMainContentbody" style=" background:#f6f6f6;min-height:75px; padding:0px; border-top:0px;display:none;">
                <div class="searchFormChose">
                    <dl>
                        <dt style="width: 100px;"><spring:message code="org.record.query.state"/>：</dt>
                        <dd class="moreSelect">
                ...
                <div class="searchFormChose">
                    <dl>
                        <dt style="width: 100px;"><spring:message code="org.record.query.stoplight"/>：</dt>
                        <dd class="moreSelect">
                ...
                <div class="searchBar" style=" position:relative;z-index:1;">
                    <span class="spanName" style="width: 109px;"><spring:message code="org.record.query.serviceType"/>：</span>
...
<textarea id="template" rows="0" cols="0" style="display: none">
    ...
    <div class="sgListLiMain xw_sgListLiMain" rid="{$T.record.id}">
        ...
        <div class="listStatic {#if $T.record.isCommit}color02{#/if}">
            <h1>{#if !$T.record.isCommit}<spring:message code="org.record.list.state.todo"/>{#else}<spring:message code="org.record.list.state.done"/>{#/if}</h1>
        ...
        <div class="sgListLiMainCenter xw_sgListLiMainCenterA">
            ...
            <ul class="sgMsg">
                <li><span><spring:message code="org.record.list.patient"/>:</span><a>{$T.record.patientName}</a></li>
                <li><span><spring:message code="org.record.list.doctor"/>:</span><a>{$T.record.doctorName}</a></li>
                <li><span><spring:message code="org.record.list.org"/>:</span><a>{$T.record.orgName}</a></li>
                <li><span><spring:message code="org.record.list.num"/>:</span><a>{$T.record.num}</a></li>
