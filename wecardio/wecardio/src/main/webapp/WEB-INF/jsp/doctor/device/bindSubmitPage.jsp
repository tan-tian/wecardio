...
<body>
<div class="">
    <form id="form" action="${path}/${sessionScope.userTypePath}/device/bindSubmit" method="post">
        <table class="userMsgTableb" style="margin:40px -20px;">
        	<input type="hidden" name="imeId" value="${imeId}"/>
        	<input type="hidden" name="pId" value="${pId}"/>
        	<tr>
                <th colspan="2">IMEI:</th>
                <td>
                    ${ime}
                </td>
                <td></td>
        	...
        	<tr>
                <th colspan="2"><spring:message code="common.device.promptSubmit"/>:</th>
                <td>
                    ${patientName}
                </td>
                <td></td>
