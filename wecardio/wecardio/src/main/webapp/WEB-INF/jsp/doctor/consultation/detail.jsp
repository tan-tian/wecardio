...
<head>
    ...
    <script type="text/javascript" src="${path}/resources/doctor/consultation/js/detail.js"></script>
</head>
<body>
<div class="pageMain">
    <div class="addressBar">
        ...
        <a class="jumpback" href="${path}/doctor/consultation/list"><spring:message code="doctor.bread.consultation"/></a>
        <span class="arrowText">&gt;</span>
        ...
        <ul class="ctrolToolbarUl">
            <c:choose>
                <c:when test="${consultation.state == 1}">
                    <shiro:hasAnyRoles name="auditDoctor">
            ...
            <div class="projetListConFoot">
                <table class="userMsgTable">
                    ...
                    <tr>
                    	...
                    	<td><spring:message code="doctor.consultation.query.editDoctor"/>:</td><th>${consultation.editDoctorName}</th>
                       	<td><spring:message code="doctor.consultation.query.auditDoctor"/>:</td><th>${consultation.auditDoctorName}</th>
                    </tr>
                    <tr>
            ...
            <div class="userDetailContHead">
                ...
                <ul class="toolBarList xw_hiddenCTR">
                	<c:if test="${(consultation.state != 2)}">
                		<li><a id="editBtn"><spring:message code="common.btn.edit"/></a></li>
                	</c:if>
