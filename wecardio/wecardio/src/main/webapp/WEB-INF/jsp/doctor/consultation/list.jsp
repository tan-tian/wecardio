...
<head>
    ...
    <script type="text/javascript" src="${path}/resources/doctor/consultation/js/list.js"></script>
</head>
<body>
<div class="pageMain">
    <div class="addressBar">
        ...
        <span class="normal"><spring:message code="doctor.bread.consultation"/></span>
        <a class="goback" onclick="history.go(-1);"><spring:message code="doctor.bread.back"/></a>
    </div>

    <div class="objBoxCont" style="margin-bottom:10px;">
        <form id="qform" action="${path}/doctor/consultation/page" method="post">
...
<textarea id="template" rows="0" cols="0" style="display: none">
    ...
    <div class="sgListLiMain xw_sgListLiMain" cid="{$T.record.id}" guid="{$T.record.guid}">
        ...
        <div class="sgListLiMainCenter xw_sgListLiMainCenter">
            ...
            <img src="${path}/resources/images/heartIco/{#if $T.record.stoplight == '2'}xin3{#elseif $T.record.stoplight == '1'}xin1{#else}xin2{#/if}.png" width="24" height="24"  style="float:right;" alt=""/>
        </div>
    </div>
    {#/for}
