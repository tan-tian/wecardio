...
<head>
    ...
    <script type="text/javascript" src="${path}/resources/patient/wallet/js/daichongLog.js"></script>
</head>
<body>
<div class="patient_purse">
    ...
    <div class="purseSearch">
        <form id="qform" action="${path}/${sessionScope.userTypePath}/service/daichongLogPage" method="post">
...
<textarea id="template" rows="0" cols="0" style=" display: none">
    <table>
        ...
        <tr class="tableTittle" >
            <td><spring:message code="admin.service.daichong.patientName"/></td>
            <td><spring:message code="admin.service.daichong.packageName"/></td>
            <td><spring:message code="admin.service.daichong.packageMoney"/></td>
