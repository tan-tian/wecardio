...
<head>
    ...
    <title><spring:message code="doctor.consultation.todo.title"/></title>
    <link rel="stylesheet" type="text/css" href="${path}/resources/css/dingdanlist_ctr.css"/>
    <script type="text/javascript" src="${path}/resources/doctor/consultation/js/todo.js"></script>
</head>
<body>
<div class="pageMain">
    ...
    <div class="objBoxCont" style="margin-bottom:10px;">
        <form id="qform" action="${path}/doctor/consultation/todoList" method="post">
    ...
    <div class="sgListLiMain xw_sgListLiMain" cid="{$T.record.id}" guid="{$T.record.guid}">
        ...
        <div class="sgListLiMainCenter xw_sgListLiMainCenter">
            ...
            <ul class="sgMsg">
                ...
                <li><span><spring:message code="doctor.consultation.list.paykind"/>：</span><a>{$T.record.payKindName}</a></li>
                <li><span><spring:message code="doctor.consultation.list.price"/>：</span><a>{$T.record.price}</a></li>
            </ul>
        </div>
    </div>
    {#/for}
