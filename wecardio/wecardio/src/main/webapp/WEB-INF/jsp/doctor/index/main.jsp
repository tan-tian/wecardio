...
<head>
    ...
    <script type="text/javascript" src="${path}/resources/doctor/index/js/main.js"></script>
</head>
<body>
<div class="headDiv">
...
<div class="BodyMain">
    <div class="leftMain xw_leftMain">
        <div id="listBox">
            <div class="menuUlBox noArrow">
                <div class="menuUlBoxHead ico_doctor menuUlBoxHeadOn" pagetype="0" hrefvalue="${path}/doctor/home" clicktype="3">
                    <h1 class="up"><spring:message code="doctor.main.profileNav"/></h1>
                    <h2>Doctor</h2><a></a>
                </div>
            </div>
            <div class="menuUlBox">
                ...
                <div class="menuUlBox">
                    ...
                    <ul class="menuBtListUl">
                        ...
                        <shiro:hasAnyRoles name="doctor">
                        	<li pagetype="2" hrefvalue="${path}/${sessionScope.userTypePath}/service/toPage/daichongLog">
							<spring:message code="admin.main.service.daichongLog"/>
                        </shiro:hasAnyRoles>
                    </ul>
                </div>
            </shiro:hasAnyRoles>
            <div class="menuUlBox">
                <div class="menuUlBoxHead ico_list" clicktype="2">
                    <h1><spring:message code="doctor.main.diagnosisNav"/></h1>
                    <h2>Diagnosis</h2><a></a>
                </div>
                <ul class="menuBtListUl">
                    <li pagetype="2" hrefvalue="${path}/doctor/consultation/todo"><spring:message code="doctor.main.consultation.todoNav"/></li>
                    <li pagetype="2" hrefvalue="${path}/doctor/consultation/list"><spring:message code="doctor.main.consultation.listNav"/></li>
                </ul>
            </div>
            <div class="menuUlBox noArrow">
                <div class="menuUlBoxHead ico_money" pagetype="0" hrefvalue="${path}/doctor/record" clicktype="3">
                    <h1><spring:message code="doctor.main.checkNav"/></h1>
                    <h2>Check</h2><a></a>
                </div>
            </div>
            <div class="menuUlBox noArrow">
            ...
            <div class="menuUlBox noArrow">
                <div class="menuUlBoxHead ico_xiaoxi" pagetype="0" hrefvalue="${path}/${sessionScope.userTypePath}/message" clicktype="3">
                    <h1><spring:message code="doctor.main.messageNav"/></h1>
                    <h2>Message</h2><a></a>
                </div>
            </div>
            <div class="menuUlBox noArrow">
    ...
    <div class="rightPage xw_rightMain">
        <iframe id="iframe" frameborder="0" width="100%" scrolling="no" src="${path}/doctor/home" onLoad="setFrameHeight()"></iframe>
    </div>
</div>
