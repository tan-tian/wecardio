                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <input class="proInput" type="text" style="width:90%;"
                                       ...
                                       data-rule-number="true" data-rule-required="true" data-rule-min="1" data-rule-max="256"
                                />
                                <font class="redstar">*</font>
                            </td>
                        </tr>
                        <tr>
                            <th><spring:message code="admin.service.btn.add.service"/>:</th>
                            <td colspan="3">
                                <input class="proInput" type="text" style="width:90%;"
                                       id="name" name="name"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="proInput" id="from" name="from" type="text" style="width:43.5%;"
                                       data-rule-required="true" data-rule-min="0" data-rule-number="true" data-rule-maxlength="10"
                                />
