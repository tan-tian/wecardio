    ...
    $(document).ready(function () {
        ...
        $('a.ico_set').on('click', function () {
            msgBox.exWindow.open({
                ...
                width : '430px',
                height : '325px',
                url : path + '/patient/password/reset'
            });
        });
...
function setFrameHeight() {
    ...
    if (ifm != null && subWeb != null) {
        try {
            ...
            if (ifm.height != Math.max(Math.min(subWeb.body.scrollHeight, subWeb.documentElement.scrollHeight), minHeight)) {
                ifm.height = 0;
                ifm.height = minHeight;
            }
        } catch (e) {
        }
    }
